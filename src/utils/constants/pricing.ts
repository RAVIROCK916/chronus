...
export const PLANS = [
  {
    ...
    features: [
      { text: "Create tasks" },
      { text: "Up to 1000 tasks", limit: "1000 tasks" },
      { text: "Customizable and branded tasks" },
      { text: "Track tasks", tooltip: "1K tasks/year" },
      {
        text: "Community support",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Up to 1000 tasks", limit: "1000 tasks" },
      { text: "Customizable and branded tasks" },
      { text: "Track tasks", tooltip: "20K tasks/month" },
      { text: "Export task data", tooltip: "Upto 1K tasks" },
      { text: "Priority support", tooltip: "Get 24/7 chat support" },
      {
        text: "AI powered suggestions",
        tooltip: "Get up to 100 AI powered suggestions",
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Customizable and branded tasks" },
      { text: "Track tasks", tooltip: "Unlimited tasks" },
      { text: "Export task data", tooltip: "Unlimited tasks" },
      {
...
export const PRICING_FEATURES = [
  {
    text: "Shorten tasks",
    tooltip: "Create shortened tasks",
  },
  {
    text: "Track clicks",
    tooltip: "Track clicks on your tasks",
  },
  {
    text: "See top countries",
    tooltip: "See top countries where your tasks are clicked",
  },
  {
    text: "Upto 10 tags",
    tooltip: "Add upto 10 tags to your tasks",
  },
  {
    text: "Community support",
    tooltip: "Community support is available for free users",
  ...
  {
    text: "AI powered suggestions",
    tooltip: "Get AI powered suggestions for your tasks",
  },
];
