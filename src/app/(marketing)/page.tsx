...
import MagicBadge from "@/components/magicui/magic-badge";
import MagicCard from "@/components/magicui/magic-card";
import { REVIEWS, COMPANIES, PROCESS } from "@/utils/misc";
      ...
      <MaxWidthWrapper>
        <div className="flex w-full flex-col items-center justify-center bg-gradient-to-t from-background text-center">
          <AnimationContainer className="flex w-full flex-col items-center justify-center text-center">
            ...
            <h1 className="font-heading w-full text-balance py-6 text-center text-5xl font-medium !leading-[1.05] tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl">
              Smart Tasks with{" "}
            ...
            <p className="mb-12 text-balance text-lg tracking-tight text-muted-foreground md:text-xl">
              Boost your productivity and stay organized with Chronus.
              <br className="hidden md:block" />
              <span className="hidden md:block">
                Create, track, and organize all your tasks in one place.
              </span>
            </p>
      ...
      <MaxWidthWrapper className="pt-10">
        <AnimationContainer delay={0.1}>
          <div className="flex w-full flex-col items-center justify-center py-8 lg:items-center">
            ...
            <h2 className="font-heading mt-6 text-center text-3xl font-medium !leading-[1.1] text-foreground md:text-5xl lg:text-center">
              Manage Tasks Like a Pro
            </h2>
            <p className="mt-4 max-w-lg text-center text-lg text-muted-foreground lg:text-center">
              Chronus is a powerful task management tool that helps you create,
              track, and organize all your tasks in one place.
            </p>
          </div>
        </AnimationContainer>
      ...
      <MaxWidthWrapper className="py-10">
        <AnimationContainer delay={0.1}>
          <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center py-8 lg:items-center">
            ...
            <h2 className="font-heading mt-6 text-center text-3xl font-medium !leading-[1.1] text-foreground md:text-5xl lg:text-center">
              Effortless task management in 3 steps
            </h2>
            <p className="mt-4 max-w-lg text-center text-lg text-muted-foreground lg:text-center">
              Follow these simple steps to create, organize, and share your
              tasks with ease.
            </p>
          </div>
        </AnimationContainer>
        ...
        <AnimationContainer delay={0.1}>
          <LampContainer>
            <div className="relative flex w-full flex-col items-center justify-center text-center">
              <h2 className="font-heading mt-8 bg-gradient-to-b from-neutral-200 to-neutral-400 bg-clip-text py-4 text-center text-4xl font-medium !leading-[1.15] tracking-tight text-transparent md:text-7xl">
                Step into the future of task management
              </h2>
              <p className="mx-auto mt-6 max-w-md text-muted-foreground">
                Experience the cutting-edge solution that transforms how you
                handle your tasks. Elevate your online presence with our
                next-gen platform.
              </p>
              <div className="mt-6">
                <Button>
