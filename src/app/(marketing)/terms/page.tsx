  ...
  return (
    <MaxWidthWrapper className="mx-auto mb-40 max-w-3xl px-8">
      <AnimationContainer delay={0.1} className="w-full">
        <h1 className="font-heading my-12 w-full text-center text-4xl font-bold md:text-6xl">
        ...
        <p className="mt-4">
          Welcome to Chronus. These terms and conditions outline the rules and
          regulations for the use of Chronus&apos;s website and services.
        </p>

        <h2 className="mt-8 text-xl font-medium">Acceptance of Terms</h2>

        <p className="mt-8 text-muted-foreground">
          By accessing and using Chronus, you accept and agree to be bound by
        ...
        <p className="mt-8 text-muted-foreground">
          Chronus reserves the right to modify these terms at any time. We will
        ...
        <p className="mt-8">
          To use Chronus, you must be at least 18 years old and capable of
        ...
        <div className="mt-8">
          You agree not to use Chronus for any unlawful or prohibited
        ...
        <p className="mt-8 text-muted-foreground">
          Chronus provides a URL shortening service that allows you to create
          shortened tassk from long URLs. You agree not to use this service to
          create tasks to illegal or harmful content.
        </p>

        <h3 className="mt-8 text-lg">Analytics</h3>
        <p className="mt-8 text-muted-foreground">
          Chronus offers analytics for your shortened URLs. You agree to use
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Chronus. However, by uploading or creating content, you grant Chronus
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Chronus does not endorse or assume any liability for user content.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          Chronus reserves the right to suspend or terminate your account at any
        ...
        <p className="mt-8 text-muted-foreground">
          Chronus is provided on an &quot;as is&quot; and &quot;as
        ...
        <p className="mt-8 text-muted-foreground">
          In no event shall Chronus be liable for any indirect, incidental,
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          please contact us at support@chronus.io.
        </p>

        <p className="mt-8 font-medium">
          By using Chronus, you acknowledge that you have read, understood, and
