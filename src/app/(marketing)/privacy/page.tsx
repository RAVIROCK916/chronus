  ...
  return (
    <MaxWidthWrapper className="mx-auto mb-40 max-w-3xl px-8">
      <AnimationContainer delay={0.1} className="w-full">
        ...
        <p className="mt-4">
          At <strong>Chronus</strong>, we are committed to protecting your
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          information. Please contact us at support@chronus.com to make this
          request.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          please contact us at support@chronus.com
        </p>
